...
class ORCFileSplitter final : public FileSplitterBase {
    public:
     ...
     // @param is_next is false if need to ask master for a new block (same or different files are possible)
     // ---------------is ture if can directly read the next block using the current file
